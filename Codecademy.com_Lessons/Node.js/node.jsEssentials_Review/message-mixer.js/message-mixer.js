...
const encryptors = require('./encryptors.js');  // If this imports all of the modules, why also import indivdually on lines 4-6? 
...
// Suggested Method: const { caesarCipher, symbolCipher, reverseCipher } = require('./encrpytors.js')
